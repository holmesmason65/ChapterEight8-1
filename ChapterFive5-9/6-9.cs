/* Mason Holmes
 * 10/4/21
 * Adds relative pathing to the form (the book's way)
 */
    ...
    public partial class frmTitles : Form
    {
        ...
        private void frmPublishers_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                booksConnection = new SqlConnection($@"Data Source=.\SQLEXPRESS; AttachDbFilename={Application.StartupPath + "SQLBooksDB.mdf"};
        ...
        private void SetState(string appState)
        {
            ...
            switch (appState)
            {
                case "View":
                    ...
                    btnEdit.Enabled = true; // supposed to be exit
                ...
                default: // Add or Edit if not in view 
                    ...
                    btnEdit.Enabled = false; // should be edit 
